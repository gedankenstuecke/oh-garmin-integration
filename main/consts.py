...
BACKFILL_SECONDS = 7776000  # Maximum allowed by the API (90 days)
BACKFILL_SLEEP_BETWEEN_CALLS = 10  # Don't decrease this, it seems to make Garmin to ignore some of our backfill requests
