...
ON_HEROKU = os.environ.get('ON_HEROKU', 'false').lower() == 'true'
if ON_HEROKU:
...
OPENHUMANS_CLIENT_ID = os.environ['OPENHUMANS_CLIENT_ID']
OPENHUMANS_CLIENT_SECRET = os.environ['OPENHUMANS_CLIENT_SECRET']
OPENHUMANS_APP_BASE_URL = os.environ['OPENHUMANS_APP_BASE_URL']
